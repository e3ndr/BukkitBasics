...
public class lang {
	...
	public static String[][] defaultData = {
			...
			{"no.perm.land", "&8[&4Server&8]&r Sorry, but you do not have permission to set home here."},
			...
			{"error.player-only", "&8[&4Server&8]&r Sorry! This command is only available to players!"},
			{"error.console-only", "&8[&4Server&8]&r Sorry! This command is only available to Console!"},
			{"error.nonexistient-player", "&8[&4Server&8]&r That player does not exist!"},
			{"error.player-never-played", "&8[&4Server&8]&r &7$player &r has never played!"},
			{"error.must-be-alphanumerical-including-&_", "&8[&4Server&8]&r $name must be alphanumerical including &7& &rand &7_"},
			...
			{"home.teleport", "&8[&4Server&8]&r Teleported you to your home &7$home."},
			{"home.teleport.others", "&8[&4Server&8]&r Teleported you to &7$player&r's home &7$home."},
			{"home.list", "&8[&4Server&8]&r Homes: &7$list"},
			{"home.delete", "&8[&4Server&8]&r Home deleted!"},
			{"home.set", "&8[&4Server&8]&r Home set!"},
			{"home.none", "&8[&4Server&8]&r You do not have a home yet!"},
			{"home.not_found", "&8[&4Server&8]&r Home not found!"},
